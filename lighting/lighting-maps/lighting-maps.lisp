...
(defun set-shader ()
  (setf *shader* (make-shader "lighting/lighting-maps/shader.vert"
                              "lighting/lighting-maps/shader.frag"))
  (setf *shader-light* (make-shader "lighting/lighting-maps/light.vert"
                                    "lighting/lighting-maps/light.frag")))
