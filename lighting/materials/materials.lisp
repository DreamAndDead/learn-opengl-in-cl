...
(defun set-shader ()
  (setf *shader* (make-shader "lighting/materials/shader.vert"
                              "lighting/materials/shader.frag"))
  (setf *shader-light* (make-shader "lighting/materials/light.vert"
                                    "lighting/materials/light.frag")))
