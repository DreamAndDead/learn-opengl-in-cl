;; https://learnopengl.com/Advanced-OpenGL/Advanecd-Data
(in-package :cl-user)
  ...
  (sdl2:with-init (:everything)
    ...
    (sdl2:with-window (win :w *width* :h *height* :flags '(:shown :opengl))
      ...
      (sdl2:with-gl-context (gl-context win)
        ...
        (setf *shader* (make-shader "advanced-opengl/advanced-data/shader.vert"
                                    "advanced-opengl/advanced-data/shader.frag"))
