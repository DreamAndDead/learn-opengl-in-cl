  ...
  (sdl2:with-init (:everything)
    ...
    (sdl2:with-window (win :w *width* :h *height* :flags '(:shown :opengl))
      ...
      (sdl2:with-gl-context (gl-context win)
        ...
        (setf *shader* (make-shader "advanced-opengl/framebuffers/shader.vert"
                                    "advanced-opengl/framebuffers/shader.frag"))
        (setf *shader-quad* (make-shader "advanced-opengl/framebuffers/quad.vert"
                                         "advanced-opengl/framebuffers/quad.frag"))
